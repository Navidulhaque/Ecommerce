...
public class UserRepositoryTests {
	...
	public void testCreateNewUserWithOneRole() {
		...
		User userMe =new User("navidul@gmail.com","navidul123","Navidul","Haque");
	...
	public void testGetUserById() {
		User userMe = repo.findById(1).get();
		System.out.println(userMe);
		assertThat(userMe).isNotNull();
	}
	
	@Test
	public void testUpdateUserDetails() {
		User userMe = repo.findById(1).get();
		userMe.setEnabled(true);
		userMe.setEmail("navidul@google.com");
		repo.save(userMe);
		System.out.println(userMe);
		assertThat(userMe).isNotNull();
	}
